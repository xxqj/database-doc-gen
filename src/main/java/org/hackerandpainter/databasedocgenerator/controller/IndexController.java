...
public class IndexController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = "dbType", value = "1:MySQL\n2:Oracle\n3:PostgreSQL\n4:SQLServer\n5:DM", defaultValue = "1", required = true),
            ...
            @ApiImplicitParam(name = "serviceName", value = "Oracle|dm数据库才需要", required = false),
    })
    public String generatorDatabaseDoc(String dbType,
        ...
        }else if ("5".equals(dbType)) {
            dataSource.setJdbcUrl("jdbc:dm://" + ip + ":" + port + "/" + serviceName);
        }
        ...
        switch (dbType) {
            ...
            case "4":
                ...
                break;
            case "5":
                generator = new Dm(databaseName, dataSource);
        }
